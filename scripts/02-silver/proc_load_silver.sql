...
BEGIN
    DECLARE @start_time DATETIME, @end_time DATETIME, 
            @table_start_time DATETIME, @table_end_time DATETIME,
    ...
    BEGIN TRY
        ...
        *,
        ...
        SET @end_time = GETDATE();
        PRINT '>> Load Duration For crm_sales_details : ' + CAST(DATEDIFF(SECOND, @start_time, @end_time) AS NVARCHAR) + ' seconds';SET @table_end_time = GETDATE();
        ...
        SET @table_end_time = GETDATE();
        PRINT '+++++++++++++++++++++++++++++++++++++++++'
        PRINT '>> Load Duration For ERP Table: ' + CAST(DATEDIFF(SECOND, @table_start_time, @table_end_time) AS NVARCHAR) + ' seconds';
